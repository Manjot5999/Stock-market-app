    ...
    <div className='bg-white border-neutral-200 w-full rounded-md relative p-3 border-2'>
      <div className=' items-center justify-center mb-4'>
        <a href={details.weburl}>
          {details.logo && <img src={details.logo} alt={details.name} className='w-16 h-16 object-contain' />}
        </a>
      ...
      <ul className='space-y-3'>
        {Object.keys(detailsList).map((item) => (
          // Conditionally render the value if it exists in the 'details' object
          details[item] && (
